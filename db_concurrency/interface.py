...
class ProjectConfiguration(wx.Frame):
    def __init__(self):
        """
        Default class constructor
        :param parent: parent window for the project configuration dialog
        """
        wx.Frame.__init__(self, None, title="Db Concurrency Tool", style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
